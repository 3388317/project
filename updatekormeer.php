...
$sql = $pdo->prepare("UPDATE kormeerka SET mshirkada='$mshirkada',cmeherada='$cmeherada',mxidhiidhka='mxidhiidh',nganacsiga='$nganacsi',nruqsada='$nruqsada',Asumada='$Asumada',dawada='$dawada',Qqiyaasta='$Qqiyaasta',xdawada='$Xdawada' WHERE ID=".$id);
$select = $sql->execute();
            ...
            <form role="form" method="POST">
             ...
             <h4>XOGTA GUUD</h4>
                 <div class="form-group">
                  ...
                  <input type="text" name="mshirkada" class="form-control" id="exampleInputEmail1" placeholder="Halkan ku qor Magaca Shirkada ama farmasiiga" value=" <?php echo ; ?>  ">
                </div>
                <div class="form-group">
